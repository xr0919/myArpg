...
namespace UGG.Move
{
    public class PlayerMovementController : CharacterMovementBase
    {
        ...
        private void UpdateRollAnimation()
        {
            ...
            if(characterAnimator.CheckAnimationTag("Roll")) CharacterMoveInterface(transform.forward,characterAnimator.GetFloat(animationMoveID) * animationMoveSpeedMult, true);
        }
